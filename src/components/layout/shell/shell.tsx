  ...
  const upperNavData = [
    {
      ...
      icon: IconCoins,
      links: [
        { label: "Supplier Price List", link: "/price-list/supplier" },
        { label: "Customer Price List", link: "/price-list/customer" },
      ],
    },
    {
      ...
      icon: IconUsersGroup,
      links: [
        { label: "Price List Maintainers", link: "/personal/pricelist-maintainers" },
